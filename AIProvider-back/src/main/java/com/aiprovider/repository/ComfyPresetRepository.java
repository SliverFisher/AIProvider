...
public class ComfyPresetRepository {
    ...
    public long insert(ComfyPresetMapper.PresetInsert preset) { mapper.insert(preset); return preset.getId(); }
    public boolean update(ComfyPresetMapper.PresetInsert preset) { return mapper.update(preset) > 0; }
