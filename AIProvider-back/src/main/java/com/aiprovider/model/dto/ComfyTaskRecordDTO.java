...
public class ComfyTaskRecordDTO {
    private String promptId, workflowId, workflowName, promptSchemeName, promptMode, positivePrompt, negativePrompt, mainModel;
    ...
    public String getPromptMode(){return promptMode;} public void setPromptMode(String v){promptMode=v;}
