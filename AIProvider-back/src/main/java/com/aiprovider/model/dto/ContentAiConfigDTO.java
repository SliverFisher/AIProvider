...
public class ContentAiConfigDTO {
    ...
    private String relevancePrompt; private String contentRewritePrompt; private String commentReplyPrompt; private BigDecimal temperature; private Integer maxOutputTokens;
    ...
    public String getRelevancePrompt(){return relevancePrompt;} public void setRelevancePrompt(String v){relevancePrompt=v;}
