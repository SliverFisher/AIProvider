...
public class ComfyPresetVO {
    ...
    public ComfyPresetVO(Long id, String name, String promptMode, Map<String, List<String>> selectedOptions,
                         String positiveExtra, String negativeExtra, String positivePrompt,
                         String negativePrompt, String remark, boolean isDefault) {
        this.id = id; this.name = name; this.promptMode = promptMode; this.selectedOptions = selectedOptions;
