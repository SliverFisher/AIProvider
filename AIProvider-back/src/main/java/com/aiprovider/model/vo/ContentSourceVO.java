...
public class ContentSourceVO {
    ...
    private final boolean credentialConfigured; private final String credentialHint; private final int pollIntervalMinutes; private final int fetchLimit; private final boolean enabled; private final String lastStatus; private final LocalDateTime lastCollectedAt; private final LocalDateTime lastTestedAt;
    public ContentSourceVO(Long id,String platform,String name,String sourceType,String externalUid,String externalHandle,String adapterType,String sourceUrl,boolean credentialConfigured,String credentialHint,int pollIntervalMinutes,int fetchLimit,boolean enabled,String lastStatus,LocalDateTime lastCollectedAt,LocalDateTime lastTestedAt){
        this.id=id;this.platform=platform;this.name=name;this.sourceType=sourceType;this.externalUid=externalUid;this.externalHandle=externalHandle;this.adapterType=adapterType;this.sourceUrl=sourceUrl;this.credentialConfigured=credentialConfigured;this.credentialHint=credentialHint;this.pollIntervalMinutes=pollIntervalMinutes;this.fetchLimit=fetchLimit;this.enabled=enabled;this.lastStatus=lastStatus;this.lastCollectedAt=lastCollectedAt;this.lastTestedAt=lastTestedAt;
    }
