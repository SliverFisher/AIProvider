...
public class XhsLoginSessionVO {
    ...
    public XhsLoginSessionVO(String sessionId,String status,String qrImageDataUrl,String message){this.sessionId=sessionId;this.status=status;this.qrImageDataUrl=qrImageDataUrl;this.message=message;}
