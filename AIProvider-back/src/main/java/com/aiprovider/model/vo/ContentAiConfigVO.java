...
public class ContentAiConfigVO {
    ...
    private final String apiBaseUrl; private final String model; private final String relevancePrompt; private final String contentRewritePrompt; private final String commentReplyPrompt;
    private final BigDecimal temperature; private final int maxOutputTokens; private final LocalDateTime updatedAt;
    public ContentAiConfigVO(String provider,boolean enabled,boolean apiKeyConfigured,String apiKeyHint,String apiBaseUrl,String model,String relevancePrompt,String contentRewritePrompt,String commentReplyPrompt,BigDecimal temperature,int maxOutputTokens,LocalDateTime updatedAt){
        this.provider=provider;this.enabled=enabled;this.apiKeyConfigured=apiKeyConfigured;this.apiKeyHint=apiKeyHint;this.apiBaseUrl=apiBaseUrl;this.model=model;this.relevancePrompt=relevancePrompt;this.contentRewritePrompt=contentRewritePrompt;this.commentReplyPrompt=commentReplyPrompt;this.temperature=temperature;this.maxOutputTokens=maxOutputTokens;this.updatedAt=updatedAt;
    }
